...
- `blocked-on`: the DateRange crossing branch waits on [`EXP-2026-08-22-01`](A12-DMKITS-SPEC-SYNC-LEDGER.md#exp-2026-08-22-01--does-the-date-range-component-set-gate-admit-two-spellings-of-one-fragment-shape), which the user carries upstream. Selecting a different gap is not blocked.
