...
|---|---|---|---|
| [Validation core](../evidence/kernel-30.8.1/captures/validation-core-v1/semantic-observations.json) | SHA-256 `e781b94e94fcc8b589aafcbbd11b64efca5a2ae175e8994b1e0db0c2e844661c` | [`ValidationProjection.lean`](../A12Kernel/Evidence/ValidationProjection.lean), `lake test`, and the public-suite evidence checks run by `checkReferenceProcess` | 49 records: 25 public associations and 24 private replays; 48 distinct external observations because one directional Number witness intentionally appears in both partitions |
