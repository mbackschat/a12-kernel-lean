...
The first member is [`string-direct-cascade-v1`](../evidence/scenarios/string-direct-cascade-v1/README.md). The scenario bytes remain only a question, but their separately retained [`Set Z4 answer`](../evidence/kernel-30.8.1/captures/string-direct-cascade-v1/README.md) now supplies the complete qualified packet, sidecars, process receipt, and no-drift report. This closes transport and retention; replayable Lean correspondence still requires the separate project-owned typed projection and binder.
