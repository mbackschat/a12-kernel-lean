...
- checked evaluated-String `Length` as a fixed scale-0 source across ordinary validation, arithmetic, wrappers, nonrepeatable computation, and generated mismatch validation, with grow-only empty zero and exact phase-selected formal unavailability
