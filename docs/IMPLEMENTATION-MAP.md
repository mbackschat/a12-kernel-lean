...
- Wider filter leaves, broader partial relevance, mixed field declarations, multi-operand encounter, RNU/group-presence adaptation, and every wider repeated consumer remain indexed by [`SG1`](SEMANTICS-GAPS.md#sg1--general-checked-document-construction) and [`SG2`](SEMANTICS-GAPS.md#sg2--general-repeatable-addressing-and-operand-construction). The shared checked condition/expression tree and narrow authored nested-Number filter are closed; the existing model-to-operator consumers include the one-level Number aggregate/`FirstFilledValue` routes and the checked filtered nested Number side.
...
- Owners: [`Semantics/FirstFilledValue.lean`](../A12Kernel/Semantics/FirstFilledValue.lean), [`Elaboration/NumericStar.lean`](../A12Kernel/Elaboration/NumericStar.lean), [`Elaboration/StarPath.lean`](../A12Kernel/Elaboration/StarPath.lean), [`Elaboration/StarNumber.lean`](../A12Kernel/Elaboration/StarNumber.lean), [`Elaboration/FirstFilledValue.lean`](../A12Kernel/Elaboration/FirstFilledValue.lean), [`Proofs/FirstFilledValue.lean`](../A12Kernel/Proofs/FirstFilledValue.lean), [`Proofs/StarPathElaboration.lean`](../A12Kernel/Proofs/StarPathElaboration.lean), [`Proofs/NumericStarElaboration.lean`](../A12Kernel/Proofs/NumericStarElaboration.lean), [`Conformance/FirstFilledValue.lean`](../A12Kernel/Conformance/FirstFilledValue.lean), [`Conformance/StarNumberElaboration.lean`](../A12Kernel/Conformance/StarNumberElaboration.lean), and [`Conformance/NumericAggregateElaboration.lean`](../A12Kernel/Conformance/NumericAggregateElaboration.lean).
- Boundary: a nonempty ordered list of resolved Number operand slots, checked construction of one unfiltered finite one-level Number star, and order-aware full/partial validation over one checked nested Number star, shared by §3, §8, §10, and §11.
...
- The scan's shared enter/step/finalize mechanism has two real consumers: ordinary resolved evaluation and checked partial validation. The partial adapter matches each topology environment against exact or ancestor relevant-entity patterns immediately before target classification, returns a distinct nonrelevant result for a reached excluded cell, and stops relevance and value reads after a present or unavailable cell.
...
- A checked-consumer law proves exact delegation to that evaluator. Cases separate selected-value versus omitted-tail and invalid-suffix invisibility, empty-prefix retention, reached invalidity in both phases, zero-row omitted-tail identity, earlier-versus-later filter encounter, and omitted capacity versus an actual earlier empty cell.
...
- Checked authored mixed-declaration construction and per-slot relevance remain indexed by [`SG2`](SEMANTICS-GAPS.md#sg2--general-repeatable-addressing-and-operand-construction), non-Number consumers by their family gaps, transition/target integration by [`SG4`](SEMANTICS-GAPS.md#sg4--computation-scheduling-and-state-transition), and retained evidence by [`SG12`](SEMANTICS-GAPS.md#sg12--retained-kernel-correspondence-coverage). Shared whole-rule integration is closed.
- Accepted [`SPEC-2026-07-20-09`](A12-DMKITS-SPEC-SYNC-LEDGER.md#spec-2026-07-20-09--firstfilledvalue-observes-only-filters-before-termination) records the peer encounter-order correction and focused locks. Pending [`SPEC-2026-07-22-06`](A12-DMKITS-SPEC-SYNC-LEDGER.md#spec-2026-07-22-06--firstfilledvalue-keeps-omitted-tail-distinct-from-an-empty-prefix) requests a dual-kernel separator for the source-established omitted-earlier-tail rule.
...
- Owners: [`Semantics/StarCompleteness.lean`](../A12Kernel/Semantics/StarCompleteness.lean), [`Semantics/StarAddressing.lean`](../A12Kernel/Semantics/StarAddressing.lean), [`Elaboration/StarPath.lean`](../A12Kernel/Elaboration/StarPath.lean), [`Elaboration/StarNumber.lean`](../A12Kernel/Elaboration/StarNumber.lean), [`Elaboration/NumericStar.lean`](../A12Kernel/Elaboration/NumericStar.lean), [`Proofs/StarCompleteness.lean`](../A12Kernel/Proofs/StarCompleteness.lean), [`Proofs/StarAddressing.lean`](../A12Kernel/Proofs/StarAddressing.lean), [`Proofs/StarPathElaboration.lean`](../A12Kernel/Proofs/StarPathElaboration.lean), [`Proofs/StarNumberElaboration.lean`](../A12Kernel/Proofs/StarNumberElaboration.lean), [`Proofs/NumericStarElaboration.lean`](../A12Kernel/Proofs/NumericStarElaboration.lean), [`Conformance/StarCompleteness.lean`](../A12Kernel/Conformance/StarCompleteness.lean), [`Conformance/StarAddressing.lean`](../A12Kernel/Conformance/StarAddressing.lean), [`Conformance/StarPathElaboration.lean`](../A12Kernel/Conformance/StarPathElaboration.lean), [`Conformance/StarNumberElaboration.lean`](../A12Kernel/Conformance/StarNumberElaboration.lean), and [`Conformance/NumericAggregateElaboration.lean`](../A12Kernel/Conformance/NumericAggregateElaboration.lean).
- Boundary: IF194's structural decision, checked model/path lowering, general document-topology construction, one unfiltered, resolved-filtered, or checked-authored-filtered nested Number cell-stream consumer, the all-rows full/partial relevance gate, and order-aware per-cell partial `FirstFilledValue` relevance for that Number source.
...
- This is internally complete at levels 1–2 for checked general group-star path lowering, model-independent nested topology resolution, the common tree/stream bridge, one checked unfiltered or narrow-authored-filtered nested Number cell stream, correlated selection before Number target classification, all-rows validation relevance, and order-aware partial Number `FirstFilledValue` over that source; the earlier finite one-level Number operator routes remain available.
- Wider authored filter leaves and Boolean surface, multi-operand per-slot filter/relevance encounter, computation-filter poison/dependency handling, globals and relevance-set admission, other field kinds, mixed declaration metadata, and checked consumers beyond the existing Number routes remain open. The resolver's construction-by-design and bridge laws tie leaves to the stream, while a stronger inductive tree/environment correspondence theorem remains part of [`SG2`](SEMANTICS-GAPS.md#sg2--general-repeatable-addressing-and-operand-construction).
