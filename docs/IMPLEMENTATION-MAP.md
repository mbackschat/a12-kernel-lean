...
- Table/open/dynamic/partial declarations, repeatable category access, scalar value-list syntax, actual path/star expansion and filtering, checked RNU scope/topology/`@From`/pointer messages, row gates, protocol exposure, and project-local portable evidence remain open
