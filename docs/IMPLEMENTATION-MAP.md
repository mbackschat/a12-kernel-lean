...
- Flat generated-computation validation and mixed ordinary whole rules reuse the same post-fire boundary and outcome. The generated fragment's optional common condition sits once outside the mismatch disjunction, guards reject direct computed-target self-reference, ERROR severity does not fix message polarity, and tolerance metadata cannot affect computation selection; expression-valued generated branches remain open.
