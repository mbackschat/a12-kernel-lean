...
- a12-dmkits `RangeCoercionDiffTest` at originating revision `0f2a5687822797ed7b4f897b0320793ae22eb7b6` supplies maintained dual-kernel-route ASCII evidence for `RangeAsString` selection and overshoot emptiness; normalized CRLF, target integration, poison, and non-ASCII representability remain internally locked but externally pending.
