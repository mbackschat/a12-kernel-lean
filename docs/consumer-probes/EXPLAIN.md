...
The bounded Explain task is cheap and useful, and its static-versus-runtime distinction now transports without renewed archaeology across DateTime day shift, nested Time construction, FullDate extraction, String-shaped direct/literal Enumeration, and homogeneous and heterogeneous whole-call operation lists. The latest probe shows that complete computed-target exclusion and typed result-channel separation survive language-neutral transport. Group containment, generated index and preliminary findings, rendered messages, scheduling, general whole-model formal checking, public shipment, and Kernel correspondence remain outside the probes.
