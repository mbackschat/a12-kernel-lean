...
| [Explain](EXPLAIN.md) | green | Structured source-first traces, exact whole-call inventories on success and post-plan failure, generated-preliminary parent-local DateRange explanation, implicit computation message polarity plus `fillToFix`, and origin-sensitive filtered-token pointers checked against Lean |
