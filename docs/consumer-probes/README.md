...
| [Explain](EXPLAIN.md) | green | Structured source-first trace plus exact whole-call formal-input inventories on success and post-plan failure checked against Lean |
