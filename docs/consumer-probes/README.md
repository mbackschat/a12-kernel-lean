...
| [Analyze](ANALYZE.md) | green; broader graph reconstruction amber | SMT-backed presence reachability, addressed extremum scale/capability and ordered identity, checked numeric-table cycle analysis, generated-computation phase-alias safety, heterogeneous fixed scalar declaration placement, and flat mandatory-information derivation including list guards, count identity, singleton severity, and validation cycles |
