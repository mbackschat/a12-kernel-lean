...
|---|---|---|
| [Execute](EXECUTE.md) | green | Exact-address DateTime application, generated numeric-table evaluation/application, selected-preliminary execution across independent typed carriers and three composition seams, explicit Number/String validation after one- and two-level application, and materialized generated Number targets |
