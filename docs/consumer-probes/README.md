...
| [Explain](EXPLAIN.md) | green | Structured source-first traces, exact whole-call inventories on success and post-plan failure, generated-preliminary parent-local DateRange explanation, and implicit computation message polarity plus `fillToFix` checked against Lean |
