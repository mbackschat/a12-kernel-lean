...
- `util/VkBigDecimal.java` — decimals: `DEFAULT_SCALE=19`; one `MathContext(50)` used by `+`, `−`, `×`, `÷`, and `^`; div-by-zero→`INVALID_NUMBER`; `kannGroesser/KleinerWerden` fillability; empty sentinels.
