...
- `remaining`: materialized document topology, later-rule execution beyond the exact one-level ordinary direct-Number and direct-String-length comparisons over normalized applied topology, transport reconstruction, and pointer-dialect rendering.
