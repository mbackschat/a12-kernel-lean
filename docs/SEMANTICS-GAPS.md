...
- `remaining`: widen the checked direct-field formal-input baseline beyond the two addressed DateTime shifts and Number-backed addressed Time construction to multi-operation union, group containment, generated index and preliminary findings, rendered messages, and other result families.
