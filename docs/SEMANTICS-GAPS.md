...
- `remaining`: inventory and measure the still-uncovered recognized rule families, wider count collector and dependency shapes, cycles, repetition and index behavior, filter internals, generated rules, and closure shapes beyond the flat acyclic matrix before widening the checked carrier.
