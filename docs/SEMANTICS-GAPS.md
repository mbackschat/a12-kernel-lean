...
- Open:
  ...
  - project the finite mixed String/Number run's family-tagged outcomes through the existing family result owners without erasing processing-context requirements or private supplied order;
