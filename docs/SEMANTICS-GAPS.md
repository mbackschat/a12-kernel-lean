...
- `remaining`: the containment-gate correction is outbound as [`SPEC-2026-08-29-01`](A12-DMKITS-SPEC-SYNC-LEDGER.md#spec-2026-08-29-01) and unreconciled; a12-dmkits currently locks the mirrored operand-only reading, so treat its account of that gate as contested until the entry is terminal.
