...
- `remaining`: widen the checked direct-field formal-input baseline to multi-operation union, group containment, generated index and preliminary findings, rendered messages, and other result families.
