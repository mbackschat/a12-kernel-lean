...
- `remaining`: repeatable bare-constant result/application correspondence for Boolean/Confirm, ordinary String, and ordinary Number, including seeded source-target classification, applied document state after target rejection, and whether a stored prior value survives.
