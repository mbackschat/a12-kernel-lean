...
- Unresolved source fact: establish constructed-Date day/year difference dispatch over the now-corrected field-mutation owners, then source month completion independently. The peer's adjacent day probes do not calibrate the source-offset/refit mechanism, which remains pending under [`SPEC-2026-07-29-01`](A12-DMKITS-SPEC-SYNC-LEDGER.md#spec-2026-07-29-01). Wider formats, legal zones/pre-floor identities, detailed basic-check errors, recursive Date expressions, repeatable placement, target/destination integration, and date-like distinct-count identity remain open.
