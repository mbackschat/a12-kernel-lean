...
- `remaining`: widen the checked multi-operation direct-field union beyond the successful three-stage Enumeration and Number-to-DateTime whole-call results to structural failures, additional whole-call families, group containment, generated index and preliminary findings, and rendered messages.
