...
- `remaining`: inventory and measure the still-uncovered recognized rule families, wider count collector and dependency shapes, longer and multi-list-edge cycle correspondence, repetition and index behavior, filter internals, generated rules, and wider closure shapes before widening the checked carrier.
