...
- Unresolved source fact: establish the first authorable recursive constructed-Date composition without dropping legacy-hybrid calendar identity or exact overlap instant. The peer's adjacent day probes still do not calibrate the source-offset/refit mechanism, which remains pending under [`SPEC-2026-07-29-01`](A12-DMKITS-SPEC-SYNC-LEDGER.md#spec-2026-07-29-01). Wider formats, legal zones/pre-floor identities, detailed basic-check errors, repeatable placement, target/destination integration, and date-like distinct-count identity remain open.
