...
- `remaining`: inventory and measure the still-uncovered recognized rule families, wider count collector and dependency shapes, longer direct cycles and cycles containing field-list guards, repetition and index behavior, filter internals, generated rules, and wider closure shapes before widening the checked carrier.
