...
- `remaining`: prove that successful generated numeric-table admission entails declaration-policy reconstruction and retire the fail-closed `targetPolicyUnavailable` runtime arm, or retain a valid admitted witness. No witness is currently known.
