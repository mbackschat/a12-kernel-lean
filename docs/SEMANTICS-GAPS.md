...
- `remaining`: exact diagnostic projection for scalar `DateFromDateTime`, direct extractor/format pairs outside validation `YearFromDate` and full-Date `HoursFromTime`, the numeric-computation error surface, and every other extraction carrier.
