...
- `remaining`: compose the checked multi-operation direct-field union with a whole admitted run, then widen it to group containment, generated index and preliminary findings, rendered messages, and other result families.
