...
- `remaining`: the consumers formerly on the complete cell view are **measured and corrected where the accounts separate**: the token distinct count and `FirstFilledValue` read the in-capacity projection on every operand form, locked by the [sweep cases](../A12Kernel/Conformance/CapacityConsumerSweep.lean) and outbound as [`SPEC-2026-08-31-14`](A12-DMKITS-SPEC-SYNC-LEDGER.md#spec-2026-08-31-14), while token value count now narrows unfiltered plain starred [String](sources/group-and-iteration-probes.md#src-token-starred-field-capacity) and [Boolean](sources/group-and-iteration-probes.md#src-boolean-starred-field-capacity) fields, outbound as [`SPEC-2026-09-01-03`](A12-DMKITS-SPEC-SYNC-LEDGER.md#spec-2026-09-01-03) and [`SPEC-2026-09-01-04`](A12-DMKITS-SPEC-SYNC-LEDGER.md#spec-2026-09-01-04).
