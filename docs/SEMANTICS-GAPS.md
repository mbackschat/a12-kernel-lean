...
- `remaining`: widen the checked multi-operation direct-field union beyond the successful three-stage Enumeration whole-call result to structural failures, other whole-call families, group containment, generated index and preliminary findings, and rendered messages.
