...
- `remaining`: five **fixed-target** gates still refuse a target outside the declaring group and are measured narrower than the Kernel: [`BooleanFirstFilledComputation.lean`](../A12Kernel/Elaboration/BooleanFirstFilledComputation.lean), [`CustomFirstFilledComputation.lean`](../A12Kernel/Elaboration/CustomFirstFilledComputation.lean), [`StringFirstFilledComputation.lean`](../A12Kernel/Elaboration/StringFirstFilledComputation.lean), [`DateRangeConstructionComputation.lean`](../A12Kernel/Elaboration/DateRangeConstructionComputation.lean), and [`IndexedDateRangeConstructionComputation.lean`](../A12Kernel/Elaboration/IndexedDateRangeConstructionComputation.lean). The temporal star family and the DateRange direct-list route are closed, which together closed both routes of all five temporal carriers.
