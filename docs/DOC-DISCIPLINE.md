...
- A newly discovered semantic obligation, changed prerequisite/blocker/reopening trigger, or completed gap updates [`SEMANTICS-GAPS.md`](SEMANTICS-GAPS.md); delete a completed entry and remove its live references rather than retaining a shipped-status list.
