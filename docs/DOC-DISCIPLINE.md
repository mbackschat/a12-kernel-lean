...
- [`IMPLEMENTER-KIT-FLAT-EMPTY-LOGIC.md`](IMPLEMENTER-KIT-FLAT-EMPTY-LOGIC.md) owns the concrete `flat-validation-empty-logic-v1` handover, its generated descriptor and suite, linked cold-test outcome, and capsule-specific open boundary.
