...
| [`PLAN.md`](PLAN.md) | Active maintainers and resuming agents | Volatile checkpoint, never an archive | Current verified baseline summary, current baseline/risk spiral, selected consumer-probe checkpoints, blockers, and minimal resume procedure |
