...
| Open semantic-work reviewer | [`SEMANTICS-GAPS.md`](SEMANTICS-GAPS.md) | Confirm the current boundary in [`IMPLEMENTATION-MAP.md`](IMPLEMENTATION-MAP.md), then inspect immediate sequencing in [`PLAN.md`](PLAN.md) |
...
| [`archived/A12-LEAN-COMPUTATION-EXECUTION-PROPOSAL.md`](archived/A12-LEAN-COMPUTATION-EXECUTION-PROPOSAL.md) | Historical computation-architecture reviewers | Immutable accepted-decision archive | Accepted rationale, rejected alternatives, detailed source-audit questions, and adoption point; live constraints are owned by [`spec/01`](../spec/01-data-model.md), [`spec/09`](../spec/09-computations.md), [`ARCHITECTURE.md`](ARCHITECTURE.md), and [`SEMANTICS-GAPS.md`](SEMANTICS-GAPS.md#sg4--computation-scheduling-and-state-transition) |
