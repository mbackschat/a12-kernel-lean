...
| Semantic-capsule pipeline designer | [`SEMANTIC-CAPSULE-PIPELINE-PROPOSAL.md`](SEMANTIC-CAPSULE-PIPELINE-PROPOSAL.md) | Stages A and B are complete; Stage C tests the shared boundary with a second real operation before the Stage D registry |
