...
| Future computation-execution maintainer | [`A12-LEAN-COMPUTATION-EXECUTION-PROPOSAL.md`](A12-LEAN-COMPUTATION-EXECUTION-PROPOSAL.md) | Check the open prerequisites and source-audit gate in [`SEMANTICS-GAPS.md`](SEMANTICS-GAPS.md#sg4--computation-scheduling-and-state-transition), then resume only when [`PLAN.md`](PLAN.md) selects SG4 |
...
| [`A12-LEAN-COMPUTATION-EXECUTION-PROPOSAL.md`](A12-LEAN-COMPUTATION-EXECUTION-PROPOSAL.md) | Computation-semantics and architecture maintainers | Accepted architectural decision | Binding future checked-plan, activation, rich-result, application, validation, compatibility, prerequisite, source-audit, and exclusion boundary for SG4; current implementation facts remain in `ARCHITECTURE.md`, `IMPLEMENTATION-MAP.md`, and `SEMANTICS-GAPS.md` |
