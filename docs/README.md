...
| [`ARTIFACTS.md`](ARTIFACTS.md) | Users and reviewers | Stable lifecycle guide | Contents, authority, generation, retention, versioning, and drift policy for `evidence/`, `reference/`, `examples/`, mutation packets/results, and generated-differential profiles/receipts |
