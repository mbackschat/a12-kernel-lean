...
| Semantics contributor | [`../CLAUDE.md`](../CLAUDE.md) | Project-owned [`../spec/SEMANTICS-MAP.md`](../spec/SEMANTICS-MAP.md), provenance in [`SOURCES.md`](SOURCES.md), outbound changes in [`A12-DMKITS-SPEC-SYNC.md`](A12-DMKITS-SPEC-SYNC.md), then [`IMPLEMENTATION-MAP.md`](IMPLEMENTATION-MAP.md) and [`TESTING.md`](TESTING.md) |
...
The language-neutral semantic body under [`../spec/`](../spec/) is owned by this project and is the bridge to a12-dmkits. Start with [`../spec/SEMANTICS-MAP.md`](../spec/SEMANTICS-MAP.md) and follow its numbered deep-dives. Verified kernel behavior belongs in the relevant spec clause; every correction, narrowing, or addition is queued in [`A12-DMKITS-SPEC-SYNC.md`](A12-DMKITS-SPEC-SYNC.md). Lean representations, proof findings, implementation state, evidence state, and plans remain under `docs/`.
...
| [`PROJECT-DESIGN.md`](PROJECT-DESIGN.md) | Contributors and stakeholders | Stable constitution | Mission, audience, authority and evidence doctrine, semantic capsules, consumer shipments, controlled-interleaving method, coverage horizons, success criteria, and long-term potential |
...
| [`PLAN.md`](PLAN.md) | Active maintainers and resuming agents | Volatile checkpoint, never an archive | Current verified baseline summary, current spiral, blockers, and minimal resume procedure |
...
| [`A12-DMKITS-SPEC-SYNC.md`](A12-DMKITS-SPEC-SYNC.md) | Cross-project semantics maintainers | Maintained reconciliation ledger; pending entries form the outbound queue | Same-change transport record for project-owned spec corrections and additions, handoff prompts, reviewed upstream revision receipts, and per-entry dispositions; never a second semantic specification |
