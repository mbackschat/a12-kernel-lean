...
| Proof contributor during the active study | [`LEAN-PROOF-ENGINEERING-PROPOSAL.md`](LEAN-PROOF-ENGINEERING-PROPOSAL.md) | [`LEAN-FORMALIZATION.md`](LEAN-FORMALIZATION.md), then the current proof and semantic modules named by the proposal |
...
| a12-dmkits capture or coordination maintainer | [`TESTING.md`](TESTING.md) | Use the [future-engagement contract](SEMANTIC-CAPSULE-PIPELINE-PROPOSAL.md#future-a12-dmkits-engagements), the live upstream [`CONFORMANCE-CORPUS-SPEC.md` §15–§15f](../../a12-rulekit/docs/CONFORMANCE-CORPUS-SPEC.md), and the accepted [`string-direct-cascade-v1` capture](../evidence/kernel-30.8.1/captures/string-direct-cascade-v1/README.md) |
| Semantic-capsule pipeline designer | [`SEMANTIC-CAPSULE-PIPELINE-PROPOSAL.md`](SEMANTIC-CAPSULE-PIPELINE-PROPOSAL.md) | Stage A is complete; Stage B is building the first shared Lean binder and direct-cascade capsule from the accepted packet |
...
| [`LEAN-PROOF-ENGINEERING-PROPOSAL.md`](LEAN-PROOF-ENGINEERING-PROPOSAL.md) | Proof contributors and maintainers | Active staged study; accepted results migrate to canonical owners and the proposal is deleted on closure | Research questions, audited corpus, explicit task order, controlled experiment matrix, acceptance criteria, pending decisions, and closure procedure |
