...
| Historical Rust experiment reviewer | [`IMPLEMENTER-KIT-FLAT-EMPTY-LOGIC.md`](IMPLEMENTER-KIT-FLAT-EMPTY-LOGIC.md#cold-test-and-qualification-outcome-2026-07-1415) | [`ARTIFACTS.md`](ARTIFACTS.md#retained-rust-qualification-records) for retained artifact authority and [`TESTING.md`](TESTING.md#historical-rust-qualification-experiment) for claim limits |
| a12-dmkits capture or coordination maintainer | [`SEMANTIC-CAPSULE-PIPELINE-PROPOSAL.md`](SEMANTIC-CAPSULE-PIPELINE-PROPOSAL.md) | Use the [upstream engagement rule](SEMANTIC-CAPSULE-PIPELINE-PROPOSAL.md#upstream-engagement-rule), the live upstream [`CONFORMANCE-CORPUS-SPEC.md` §15–§15h](../../a12-rulekit/docs/CONFORMANCE-CORPUS-SPEC.md), and the settled [`string-direct-cascade-v1` raw capture](../evidence/kernel-30.8.1/captures/string-direct-cascade-v1/README.md) plus its certified [`semantic-observations.json`](../evidence/kernel-30.8.1/captures/string-direct-cascade-v1/semantic-observations.json) |
| a12-dmkits capture-V1 retirement maintainer | [`A12-DMKITS-CAPTURE-V1-RETIREMENT-PROPOSAL.md`](A12-DMKITS-CAPTURE-V1-RETIREMENT-PROPOSAL.md) | Transfer the copy-ready owner-directed deletion prompt, then keep the handoff stable until a committed upstream disposition returns |
...
| Reference/evidence simplification maintainer | [`REFERENCE-AND-EVIDENCE-SIMPLIFICATION-PROPOSAL.md`](REFERENCE-AND-EVIDENCE-SIMPLIFICATION-PROPOSAL.md) | Evaluate and, if adopted, retire local reference V1, then execute the measured one-time compact-evidence deletion wave without cutting current semantics or V2 |
...
| [`SEMANTIC-CAPSULE-PIPELINE-PROPOSAL.md`](SEMANTIC-CAPSULE-PIPELINE-PROPOSAL.md) | a12-kernel-lean architecture and evidence maintainers | Accepted operating contract | Compact producer-certified bundle boundary, assurance tiers, measured line budgets, upstream engagement rule, capture-V1 retirement boundary, and stop criteria; current implementation facts remain in `ARCHITECTURE.md`, `TESTING.md`, `ARTIFACTS.md`, and `IMPLEMENTATION-MAP.md` |
...
| [`REFERENCE-AND-EVIDENCE-SIMPLIFICATION-PROPOSAL.md`](REFERENCE-AND-EVIDENCE-SIMPLIFICATION-PROPOSAL.md) | Repository and evidence maintainers | Proposal until adopted and implemented; then archive or delete | Measured local reference-V1 retirement, compact evidence migration, raw-archive tradeoff, target sizes, deletion order, and gates |
| [`A12-DMKITS-CAPTURE-V1-RETIREMENT-PROPOSAL.md`](A12-DMKITS-CAPTURE-V1-RETIREMENT-PROPOSAL.md) | a12-dmkits owner and cross-project maintainer | Temporary handoff; delete after accepted upstream disposition | Exact capture-V1 retirement decision, historical anchors, deletion boundary, copy-ready upstream prompt, and expected handback; never upstream live status |
