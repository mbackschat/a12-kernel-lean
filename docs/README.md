...
| a12-dmkits capture or coordination maintainer | [`SEMANTIC-CAPSULE-PIPELINE-PROPOSAL.md`](SEMANTIC-CAPSULE-PIPELINE-PROPOSAL.md) | Use its [upstream engagement rule](SEMANTIC-CAPSULE-PIPELINE-PROPOSAL.md#upstream-engagement-rule), the live upstream [`CONFORMANCE-CORPUS-SPEC.md` §15–§15f](../../a12-rulekit/docs/CONFORMANCE-CORPUS-SPEC.md), and the accepted [`string-direct-cascade-v1` capture](../evidence/kernel-30.8.1/captures/string-direct-cascade-v1/README.md) |
