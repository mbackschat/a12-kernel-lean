...
- [`TESTING.md`](TESTING.md) — the red/green Lean workflow, executable conformance harness, proof/trust gate, kernel replay method, and final verification checklist.
