...
- **[`IMPLEMENTER-KIT-FLAT-EMPTY-LOGIC.md`](IMPLEMENTER-KIT-FLAT-EMPTY-LOGIC.md)** — the first development cold-handover slice: eight evidence-derived flat-validation cases, exact empty/malformed/verdict rules, law and non-law maps, cold-implementation prompt, seeded divergences, and explicit non-release boundary. Its generated machine-readable entry points are the [`flat-validation-empty-logic-v1` capability descriptor](../reference/flat-validation-empty-logic-v1.capability.json), [conformance suite](../reference/flat-validation-empty-logic-v1.conformance.json), and [fixture directory](../examples/reference-cli/flat-evidence/).
- **[`IMPLEMENTER-KIT-CORRELATION.md`](IMPLEMENTER-KIT-CORRELATION.md)** — the captured-outer implementation capsule: exact one-star model and algorithm, worked traces, evidence/law/non-law maps, Rust playbook, candidate suite commands, and open release boundary.
...
| Development `flat-validation-empty-logic-v1` cold-handover material, generated capability descriptor and suite, evidence classifications, prompts, and capsule-specific gaps | [`IMPLEMENTER-KIT-FLAT-EMPTY-LOGIC.md`](IMPLEMENTER-KIT-FLAT-EMPTY-LOGIC.md) |
