...
| [`ARTIFACTS.md`](ARTIFACTS.md) | Users and reviewers | Stable lifecycle guide | Contents, authority, generation, retention, versioning, and drift policy for `evidence/`, `reference/`, `examples/`, tracked qualification source, ignored packets, and downstream results |
...
| [`TESTING.md`](TESTING.md) | Contributors | Maintained methodology | Red/green workflow, executable and process harness mechanics, mutation-qualification packet/replay/checker mechanics, proof/trust gates, evidence replay procedure, and final verification commands |
