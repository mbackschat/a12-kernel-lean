...
- `local-consequence`: none. The clauses this reproduces were already landed and locked here from this project's own probes; the value is an independent second estate agreeing, on a different fixture and a third engine.
