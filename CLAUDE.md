...
The language-neutral semantics live in read-only [`spec/`](spec/) — start at [`spec/SEMANTICS-MAP.md`](spec/SEMANTICS-MAP.md) and follow the numbered deep-dives. [`docs/README.md`](docs/README.md) indexes the living project documentation; [`docs/PRODUCT-PROPOSAL.md`](docs/PRODUCT-PROPOSAL.md) owns the general consumer-task taxonomy and product progression, while [`docs/USE-CASES.md`](docs/USE-CASES.md) is its user-facing potential map; [`docs/IMPLEMENTATION-MAP.md`](docs/IMPLEMENTATION-MAP.md) tracks clause-level Lean/proof/evidence status; [`docs/IMPLEMENTER-GUIDE.md`](docs/IMPLEMENTER-GUIDE.md) owns the semantic-shipment, research-closure, and independent-consumer contract; [`docs/IMPLEMENTER-KIT-CORRELATION.md`](docs/IMPLEMENTER-KIT-CORRELATION.md) is the concrete one-star `$` evaluator handover; [`docs/IMPLEMENTER-KIT-FLAT-EMPTY-LOGIC.md`](docs/IMPLEMENTER-KIT-FLAT-EMPTY-LOGIC.md) is the smaller evidence-bound cold-evaluator handover; [`docs/LEAN-FINDINGS.md`](docs/LEAN-FINDINGS.md) records durable formalization findings; [`docs/LEAN-FORMALIZATION.md`](docs/LEAN-FORMALIZATION.md) owns Lean's role and trust contract; [`docs/ARCHITECTURE.md`](docs/ARCHITECTURE.md) records concrete encoding decisions; [`docs/PROTOCOL.md`](docs/PROTOCOL.md) owns the normalized reference process contract; [`docs/PRODUCTION-RELEASE.md`](docs/PRODUCTION-RELEASE.md) owns production artifact qualification and measured release experiments. [`spec/13-lean-encoding-guide.md`](spec/13-lean-encoding-guide.md) remains consulted staged guidance, not a writable plan.
