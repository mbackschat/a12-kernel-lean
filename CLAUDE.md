...
The current source-maintained capture request and the longer-term amortized workflow are specified in [`docs/A12-DMKITS-CAPTURE-PROPOSAL.md`](docs/A12-DMKITS-CAPTURE-PROPOSAL.md) and [`docs/SEMANTIC-CAPSULE-PIPELINE-PROPOSAL.md`](docs/SEMANTIC-CAPSULE-PIPELINE-PROPOSAL.md).
