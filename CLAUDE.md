...
- [`A12Kernel/Qualification/`](A12Kernel/Qualification/), [`A12Kernel/Process/`](A12Kernel/Process/), and [`A12Kernel/MutationQualificationMain.lean`](A12Kernel/MutationQualificationMain.lean) — source-side qualification packets, strict result checking, disposable candidate replay, adversarial self-tests, shared process helpers, and their CLI. The qualification directory and CLI are not imported by the trusted library, conformance, proof, or evidence roots; `Process/` supplies shared IO helpers and carries no semantic or evidence authority. [`docs/TESTING.md`](docs/TESTING.md) owns the method and commands, while [`docs/ARTIFACTS.md`](docs/ARTIFACTS.md) owns packet and record lifecycle.
