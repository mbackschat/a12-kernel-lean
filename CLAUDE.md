...
The language-neutral semantics live in read-only [`spec/`](spec/) — start at [`spec/SEMANTICS-MAP.md`](spec/SEMANTICS-MAP.md) and follow the numbered deep-dives. [`docs/README.md`](docs/README.md) indexes the living project documentation; [`docs/IMPLEMENTATION-MAP.md`](docs/IMPLEMENTATION-MAP.md) tracks clause-level Lean/proof/evidence status; [`docs/IMPLEMENTER-GUIDE.md`](docs/IMPLEMENTER-GUIDE.md) owns the independent-interpreter handover and research-closure contract; [`docs/LEAN-FINDINGS.md`](docs/LEAN-FINDINGS.md) records durable formalization findings; [`docs/LEAN-FORMALIZATION.md`](docs/LEAN-FORMALIZATION.md) owns Lean's role and trust contract; [`docs/ARCHITECTURE.md`](docs/ARCHITECTURE.md) records concrete encoding decisions; [`docs/PROTOCOL.md`](docs/PROTOCOL.md) owns the normalized reference process contract; [`docs/PRODUCTION-RELEASE.md`](docs/PRODUCTION-RELEASE.md) owns production artifact qualification and measured release experiments. [`spec/13-lean-encoding-guide.md`](spec/13-lean-encoding-guide.md) remains consulted staged guidance, not a writable plan.
...
lake exe checkReferenceProcess      # run the independent black-box CLI/fixture/manifest gate
...
- [`A12Kernel/Reference/`](A12Kernel/Reference/) — the normalized protocol vocabulary, strict JSON and exact-decimal transport, generated support metadata, closed decoder, and pure adapter to the existing checked flat evaluator. These process-boundary modules are outside the library, conformance, and trusted-proof roots.
...
- [`A12Kernel/ReferenceMain.lean`](A12Kernel/ReferenceMain.lean) and [`A12Kernel/ReferenceProcessTestMain.lean`](A12Kernel/ReferenceProcessTestMain.lean) — the one-request CLI and its independent process-level regression gate. [`docs/PROTOCOL.md`](docs/PROTOCOL.md) owns the public contract.
