...
- Record a small finding in [`docs/A12-DMKITS-FEEDBACK.md`](docs/A12-DMKITS-FEEDBACK.md), or use a separate cross-project proposal when the change is a coherent capability with its own design and acceptance lifecycle. Include source evidence, the broken or missing invariant, a specific recommendation, compatibility consequences, separating acceptance cases, and copy-ready prompts when they help the upstream agent.
...
- After handback, reconcile the proposal against the actual revision, verify the maintained command and portable artifacts, and record the disposition. Do not reproduce the upstream implementation locally.
...
The source-maintained capture contract and the longer-term amortized workflow are specified in [`docs/A12-DMKITS-CAPTURE-PROPOSAL.md`](docs/A12-DMKITS-CAPTURE-PROPOSAL.md) and [`docs/SEMANTIC-CAPSULE-PIPELINE-PROPOSAL.md`](docs/SEMANTIC-CAPSULE-PIPELINE-PROPOSAL.md); [`docs/PLAN.md`](docs/PLAN.md) owns the live revision and first-client status.
