import A12Kernel.Elaboration.ValidationCondition.StaticIteration
...
/-- Compatibility specialization for the established iteration-legality consumer. -/
def iterationHostInt32? := javaRoundedInt32?
