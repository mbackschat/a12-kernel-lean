...
Scope: the codes below cover the established field-list operand-admission, fixed filled-group computation-admission, computed Number target-scale, String pattern-comparison, and raw-String length-admission families. Coverage, per-mapping evidence status, and remaining families belong to [`IMPLEMENTATION-MAP.md`](../../docs/IMPLEMENTATION-MAP.md); [`SEMANTICS-GAPS.md`](../../docs/SEMANTICS-GAPS.md) owns the open axis.
-/
