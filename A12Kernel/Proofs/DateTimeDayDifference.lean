...
These laws characterize the signed partial day-difference API over the pinned versioned Berlin profile. They do not claim correspondence for another zone or calendar basis.
-/
