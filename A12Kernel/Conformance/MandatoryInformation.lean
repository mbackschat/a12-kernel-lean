...
/- The unfiltered repeatable presence matrix preserves both operator and connective identity rather than flattening every starred branch into an ordinary negative field. -/
example :
