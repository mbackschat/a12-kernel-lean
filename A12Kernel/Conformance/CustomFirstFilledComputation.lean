...
private def checkedAt? (declaringGroup : GroupPath) (targetField : FieldId)
  ...
  (checkCustomFirstFilledComputation model declaringGroup targetField authored).toOption
