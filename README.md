...
| Evidence replay | Historical exporter revision `1b5f463b89adc6cfb81b41121cd6c97855e8cbe3` certifies [`semantic-observations.json`](evidence/kernel-30.8.1/captures/string-direct-cascade-v1/semantic-observations.json), SHA-256 `1d8d253e553eba70fa990975666884833748bed9d9b2b6483f472767a9837c7a`; the bounded `ObservationBundle` reader and typed `StringCascadeProjection` pin, decode, and replay its five cases. The complete raw answer is recoverable from the [archived evidence record](docs/archived/STRING-DIRECT-CASCADE-RAW-EVIDENCE.md), not kept in the current checkout. a12-dmkits retired the unused portable capture V1 implementation from current `main` at `45b264b2`; ordinary corpus and kernel-differential facilities remain available, while any future richer producer capability is demand-driven by a concrete semantic family |
