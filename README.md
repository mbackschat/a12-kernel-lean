...
| Evidence transport | a12-dmkits now provides the maintained, repaired portable capture/qualification boundary; the exact [`string-direct-cascade-v1` question](evidence/scenarios/string-direct-cascade-v1/README.md) is structurally accepted, but it is not evidence until the first official qualified packet is returned and retained |
