...
| §5 | Numbers & decimals | Static scale gates `==`; three rounding modes; scale-19 rescale; quiet div-by-zero; checked String/Enumeration-to-Number conversion and its direct rounding/absolute wrappers | ★★★★☆ | [`04-numbers-and-decimals.md`](04-numbers-and-decimals.md) |
