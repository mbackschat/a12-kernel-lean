...
| §5 | Numbers & decimals | Static scale gates `==`; three rounding modes; scale-19 rescale; quiet div-by-zero; checked conversions, aggregates, temporal-derived Number sources, and staged rounding/absolute wrappers over admitted number-like children | ★★★★☆ | [`04-numbers-and-decimals.md`](04-numbers-and-decimals.md) |
