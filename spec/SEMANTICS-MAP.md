...
| §8 | Enumerations | Compare by stored value; display-bearing comparability; category `->`; multi-field value-list quantifiers and scalar membership | ★★★☆☆ | [`06-strings-and-enumerations.md`](06-strings-and-enumerations.md) |
...
| §11 | Computations | First-match execution plus all-alternatives generated validation; rich V2 result and change projections; empty-cascade vs poison | ★★★★★ | [`09-computations.md`](09-computations.md) |
