...
| §9 | Repetition, iteration & cross-array eval | Rules become per-row queries; ordinary scope comes from compatible condition references, not error placement; negative admission is level-, connective-, operator-, and operand-sensitive across typed direct field operations and ordered Date differences; joins by index; ordered aggregates; `Having`/`$`; star binding | ★★★★★ | [`07-repetition-and-iteration.md`](07-repetition-and-iteration.md) |
