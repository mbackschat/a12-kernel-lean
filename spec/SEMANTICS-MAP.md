...
| §5 | Numbers & decimals | Static scale gates `==`; three rounding modes; scale-19 rescale; quiet div-by-zero; checked conversions, aggregates, temporal-derived Number sources, and plain-body rounding/absolute wrappers at ordinary arithmetic positions | ★★★★☆ | [`04-numbers-and-decimals.md`](04-numbers-and-decimals.md) |
...
| §9 | Repetition, iteration & cross-array eval | Rules become per-row queries; scope from references; joins by index; ordered aggregates; `Having`/`$`; star binding | ★★★★★ | [`07-repetition-and-iteration.md`](07-repetition-and-iteration.md) |
...
| §11 | Computations | First-match execution plus all-alternatives generated validation; rich V2 result, eager formal-operand prepass, and change projections; empty-cascade vs poison | ★★★★★ | [`09-computations.md`](09-computations.md) |
