...
| §5 | Numbers & decimals | Static scale gates `==`; three rounding modes; scale-19 rescale; quiet div-by-zero; digits-only String-range conversion | ★★★★☆ | [`04-numbers-and-decimals.md`](04-numbers-and-decimals.md) |
