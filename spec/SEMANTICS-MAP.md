...
| §5 | Numbers & decimals | Static scale gates `==`; three rounding modes; scale-19 rescale; quiet div-by-zero; checked conversions, aggregates, temporal-derived Number sources, and complete plain arithmetic beneath root rounding/absolute wrappers | ★★★★☆ | [`04-numbers-and-decimals.md`](04-numbers-and-decimals.md) |
